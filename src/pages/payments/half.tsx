...
export default function PaymentSelection() {
    ...
    const handleCopyPix = () => {
        const pixContent = "00020126580014BR.GOV.BCB.PIX01364020319b-f23e-4f77-9dcd-f100e06059ce520400005303986540590.005802BR5906Retiro6010Coromandel62070503***6304CAF2";
                ...
                >
                    {selectedOption === 'pix' && (
                        <div className='flex flex-col justify-center items-center '>
                            ...
                            <label className='text-yellow-600 text-2xl font-bold'>R$ 90,00</label>
                    ...
                    {selectedOption === 'cartao' && (
                                                <div className='flex flex-col justify-center items-center '>
                                                <label className='text-white text-2xl'>Valor da compra:</label>
                                                <label className='text-yellow-600 text-2xl font-bold'>R$ 100,00</label>
                                                <div className='flex flex-col gap-2 mt-3'>
                                                    <h1 className='text-white text-[20px] font-bold flex'>Instruções para pagamento:</h1>
                                                    <div className="gap-3 flex flex-col">
                                                        <label className='flex'>
                                                ...
                                                <div className='justify-end flex items-end w-full mt-3'>
                                                    <Link className="bg-yellow-800 text-white font-bold text-xl rounded-xl p-2" href="https://link.stone.com.br/t/chk_38vjrKLCWbsZ7Kpn">
                                                        Avançar
                                                    </Link>
                                                </div>
                                            </div>
